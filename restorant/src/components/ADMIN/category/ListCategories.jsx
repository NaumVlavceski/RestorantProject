                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="min-w-0">
                                <h2 className="text-lg sm:text-xl font-bold text-gray-800 truncate">Categories</h2>
                                <p className="text-xs sm:text-sm text-gray-500">Total {categories.length} categories</p>
                            </div>
                        </div>
                                ...
                                >
                                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                        ...
                                        <div className="flex flex-col sm:flex-row gap-2">
                                            <button
                                                onClick={() => navigate(`/admin/editCategory/${item.id}`)}
                                                className="w-full sm:w-auto justify-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200
