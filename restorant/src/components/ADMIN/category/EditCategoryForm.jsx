...
const EditCategoryForm = () => {
    ...
    useEffect(() => {
        document.title = "Edit Category " + categoryId
        apiFetch(`/editCategory/${categoryId}/`)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await apiFetch(`/editCategory/${categoryId}/`, {
                method: 'POST',
                body: formDataToSend,
                credentials :false
            });
                        ...
                        <div className="md:flex gap-8">
                            ...
                            <div className="md:w-1/2 pt-2">
                                <div className="mb-4">
                                    ...
                                    <p className="text-sm text-gray-500">Промени наслов.</p>
                                </div>
