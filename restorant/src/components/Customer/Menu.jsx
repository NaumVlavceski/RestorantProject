    ...
    return (
        ...
        <section id='menu' className="relative py-6 w-full min-h-screen bg-gradient-to-b from-gray-900 to-gray-800">
            ...
            <div className="relative px-4 mb-8">
                ...
                {tableId && (
                    <div className="absolute top-0 right-4 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2">
                        <span className="text-white font-semibold">{t.table} {tableId}</span>
                    </div>
                )}
            </div>
            ...
            {/* Категории */}
            <div className="relative px-4 mb-10">
                {/*<h2 className="text-white text-xl md:text-2xl text-center font-bold mb-4"></h2>*/}
                <div
                        ...
                        >
                            <div
                                ...
                                <img
                                    ...
                                    src={"https://res.cloudinary.com/" + item.photo}
                                    alt={item.title}
                                    className="w-full h-full object-cover hover:scale-110 transition-transform duration-300"
                                />
                            </div>
                                ...
                                >
                                    ...
                                    <td className="py-4 px-3 align-top">
                                        ...
                                        <div className="space-y-2 flex justify-between">
                                            <div>
                                                {l==='mk' ? <h3 className="text-white text-lg md:text-xl font-bold">{food.titleMK}</h3> : <h3 className="text-white text-lg md:text-xl font-bold">{food.title}</h3>}
